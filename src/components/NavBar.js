    ...
    <Navbar expand="lg" className={scrolled ? "site-nav scrolled" : "site-nav"}>
      <Container>
        <Navbar.Brand href="#home" className="brand-mark" aria-label="Neha Pattnayak home">
          <span className="signature-word">Neha</span><span className="signature-period">.</span>
        ...
        <Navbar.Collapse id="portfolio-nav">
          <Nav className="ms-auto align-items-lg-center">
            ...
            <a className="nav-cta" href="#connect"><span className="nav-cta-label">Let's connect</span><span className="nav-cta-arrow" aria-hidden="true">↗</span></a>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
